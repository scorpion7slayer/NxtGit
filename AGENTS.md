...
- **AI Providers**: Multiple providers supported via `src/lib/ai.ts`:
  - **GitHub Copilot** — OAuth device flow, token caching with expiry, models: gpt-4.1, o3-mini, Codex-sonnet-4, etc.
